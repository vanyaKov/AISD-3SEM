...
int map[V][V] = { 
        { INT_MAX, 25, 40, 31, 27, 23, 12, 13},
        { 5, INT_MAX, 17, 30, 25, 10, 15, 8},
        { 19, 15, INT_MAX, 6, 1, 2, 17, 20},
        { 9, 50, 24, INT_MAX, 6, 22, 13, 26},
        { 2, 8, 7, 10, INT_MAX, 5, 7, 2},
        { 2, 8, 7, 10, 5, INT_MAX, 20, 13},
        { 2, 8, 7, 10, 14, 16, INT_MAX, 21},
        { 2, 8, 7, 10, 12, 15, 23, INT_MAX} };
struct individual {
    string gnome;
    int fitness;
};
